...
class ScatterGeneratorSettings:
    ...
    def __init__(self):
        ...
        self.output_dir = # here add the complete path to the directory where images must be copied/saved
        ...
        self.texture_file = # path to the directory containing the file old_paper.png
